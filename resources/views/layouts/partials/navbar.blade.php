    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                @auth
                    @if(auth()->user()->can('users.student'))
                        <li><a href="{{ route('users.student') }}" class="nav-link px-2 text-white">Students</a></li>
                    @endif
                        @if(auth()->user()->can('users.mentor'))
                            <li><a href="{{ route('users.mentor') }}" class="nav-link px-2 text-white">Mentors</a></li>
                        @endif
                    @role('admin')
